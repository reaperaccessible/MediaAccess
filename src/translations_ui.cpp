...
void RegisterUiTranslations() {
    ...
    AddTranslation("en", "Could not rename the playlist", L"Could not rename the playlist");
    AddTranslation("fr", "Could not rename the playlist", L"Impossible de renommer la liste");
    AddTranslation("en", "First,",                      L"First,");
    AddTranslation("fr", "First,",                      L"Premier,");
    AddTranslation("en", "Last,",                       L"Last,");
    AddTranslation("fr", "Last,",                       L"Dernier,");
    AddTranslation("en", "tracks",                      L"tracks");
    AddTranslation("fr", "tracks",                      L"pistes");
    AddTranslation("en", "No playlist selected",        L"No playlist selected");
    AddTranslation("fr", "No playlist selected",        L"Aucune liste sélectionnée");
    AddTranslation("en", "Playlist removed from the list", L"Playlist removed from the list");
    AddTranslation("fr", "Playlist removed from the list", L"Liste retirée du menu");
    AddTranslation("en", "Delete this playlist file from the disk as well?", L"Delete this playlist file from the disk as well?");
    AddTranslation("fr", "Delete this playlist file from the disk as well?", L"Supprimer aussi le fichier de la liste sur le disque ?");
    AddTranslation("en", "Delete playlist",             L"Delete playlist");
    AddTranslation("fr", "Delete playlist",             L"Supprimer la liste");
    AddTranslation("en", "Could not delete the file",   L"Could not delete the file");
    AddTranslation("fr", "Could not delete the file",   L"Impossible de supprimer le fichier");
    AddTranslation("en", "playlists added",             L"playlists added");
    AddTranslation("fr", "playlists added",             L"listes ajoutées");
    AddTranslation("en", "No playlist in clipboard",    L"No playlist in clipboard");
    AddTranslation("fr", "No playlist in clipboard",    L"Aucune liste dans le presse-papiers");
