...
static const Action g_actions[] = {
    ...
    { "FILE_PODCAST",             IDM_FILE_PODCAST,           ActionCategory::Main,
      "Podcasts...",                  "Podcasts...",
      { 'P', true,  true,  false } },
    { "FILE_YTSUBS",              IDM_FILE_YTSUBS,            ActionCategory::Main,
      "YouTube subscriptions...",     "Abonnements YouTube...",
      { 0, false, false, false } },
    ...
    { "BOOKMARK_LIST",            IDM_BOOKMARK_LIST,          ActionCategory::Main,
      ...
      { 'M', true,  false, false } },
    { "BOOKMARK_PREV",            IDM_BOOKMARK_PREV,          ActionCategory::Main,
      "Previous bookmark",            "Signet précédent",             {} },
    { "BOOKMARK_NEXT",            IDM_BOOKMARK_NEXT,          ActionCategory::Main,
    ...
    { "HELP_CHANGELOG",           IDM_HELP_CHANGELOG,         ActionCategory::Main,
      "Open changelog",               "Ouvrir le journal des modifications",
      { VK_F2,  false, false, false } },
    ...
    { "GLOBAL_VOLUP_10DB",        IDM_PLAY_VOLUP_10DB,        ActionCategory::Global,
      "Volume up 10% (global)",       "Volume plus haut de 10 % (global)", {} },
    { "GLOBAL_VOLDOWN_10DB",      IDM_PLAY_VOLDOWN_10DB,      ActionCategory::Global,
      "Volume down 10% (global)",     "Volume plus bas de 10 % (global)", {} },
    ...
    { "GLOBAL_YT_DL_PLAYING_MP3", IDM_YT_DL_PLAYING_MP3,      ActionCategory::Global,
      "Download currently playing YouTube video (audio MP3) (global)",
      "Télécharger la vidéo YouTube en cours de lecture (audio MP3) (global)", {} },
    ...
    { "GLOBAL_BOOKMARK_PREV",     IDM_BOOKMARK_PREV,          ActionCategory::Global,
      "Previous bookmark (global)",   "Signet précédent (global)",    {} },
    { "GLOBAL_BOOKMARK_NEXT",     IDM_BOOKMARK_NEXT,          ActionCategory::Global,
      "Next bookmark (global)",       "Signet suivant (global)",      {} },
