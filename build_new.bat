...
set "SOURCES=%SOURCES% src\tempo_processor.cpp src\youtube.cpp src\center_cancel.cpp src\convolution.cpp src\download_manager.cpp src\updater.cpp src\spatial_audio.cpp src\video_engine.cpp src\ytdlp_updater.cpp src\logger.cpp src\keyboard_help.cpp src\actions.cpp src\keymap.cpp src\actions_window.cpp src\daisy_book.cpp src\daisy_player.cpp src\books_dialog.cpp src\tts_player.cpp src\book_text_window.cpp src\sleep_timer.cpp src\cli_switches.cpp src\audio_slots.cpp src\wasapi_loopback.cpp src\audio_device_watcher.cpp src\cue_sheet.cpp src\edge_tts_client.cpp src\subtitle_scheduler.cpp deps\miniz\miniz.c"
